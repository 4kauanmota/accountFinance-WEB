...
public class AccountsReceivable {
    ...
    public AccountsReceivable(int id, String provider, String description, double value, Date expirationDate, Date paymentDate, String paymentMethod, Account account) {
        this.id = id;
